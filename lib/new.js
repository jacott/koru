...
module.exports = (name, options)=>{
  ...
  Object.assign((package.dependencies || (package.dependencies = {})), {
    koru: koruVersion,
    'pg-libpq': options.koruPackage.devDependencies['pg-libpq'],
  });
  ...
  const koruExec = './scripts/koru';

  if (options.force || ! pathExists(koruExec)) {
    files.push('scripts/koru');

    if (! (options.pretend || pathExists(koruExec)))
      fs.symlinkSync('../node_modules/.bin/koru', koruExec);
  }
