isServer && define((require, exports, module) => {
  ...
  TH.testCase(module, ({before, after, beforeEach, afterEach, group, test}) => {
    ...
    test('execute/fetch with rows, setMapped', async () => {
      ...
      const ps1 = new PgPrepSql(`select * from unnest(Array[$1,$2,$3], Array[$4,$5,$6]) as x(a,b)`)
        .setParamMapper(6, (obj, callback) => {
          for (const name in obj) callback(obj[name], name[0] === 'a' ? 25 : 21);
        });

      assert.equals(
        await ps1.execute(client, {a1: 'a1', a2: 'a2', a3: 'a3', b1: 1, b2: 2, b3: 3}),
    ...
    test('cursor', async () => {
      ...
      const cursor = new PgPrepSql(`SELECT * from unnest(Array[1,$1,2], Array[4,5,6]) as x(a,b)`)
        .setOids([21]).openCursor(client, 'p1', [20]);
