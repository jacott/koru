define(function(require, exports, module) {
  ...
  const {toBinb, utf8Encode} = require('koru/env!./acc-sha256');
  ...
  const core_sha256 = (
    m, l, H=[0x6A09E667, 0xBB67AE85, 0x3C6EF372, 0xA54FF53A,
  ...
  return {
    add: (s, h) => {
      const ab = utf8Encode(s);
      return core_sha256(toBinb(ab), ab.length * 8, h);
    },
