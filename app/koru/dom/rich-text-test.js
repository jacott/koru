  ...
  TH.testCase(module, ({after, beforeEach, afterEach, group, test}) => {
    ...
    group('validation', () => {
      test('simple', () => {
        ...
        assert(RichText.isValid('code:rb\n"a"\ncode:rb\nb', [CODE, 0, 1, 48, OL, 0, 3, CODE, 1, 1]));
      });
    });
    ...
    test('special', () => {
      ...
      TH.onEnd(() => {RichText.deregisterLinkType(1)});
    ...
    test('linkType', () => {
      assert.equals(RichText.linkType(0), {id: 0, class: '', fromHtml: TH.match.func, toHtml: TH.match.func});
    });
    ...
    test('font', () => {
      ...
      assert.equals(RichText.fromHtml(Dom.h({div: {font: 'foo', $face: 'foo-face'}})), ['foo', [FONT, 0, 0, 3, 5]]);
