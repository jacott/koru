...
define((require, exports, module) => {
  ...
  TH.testCase(module, ({before, beforeEach, afterEach, group, test}) => {
    group('normalize', () => {
      ...
      test('downcase', async () => {
        //[
        Book.defineFields({title: {type: 'text', normalize: 'downcase'}});
      ...
      test('upcase', async () => {
        //[
        Book.defineFields({title: {type: 'text', normalize: 'upcase'}});
        const book = Book.build({title: 'Animal Farm'});
        assert(await book.$isValid());
    ...
    test('multi validators', async () => {
      Book.defineFields({title: {type: 'text', normalize: 'upcase', trim: true}});
    ...
    group('boolean', () => {
      ...
      test('trueOnly', async () => {
        //[
        // trueOnly
        Book.defineFields({inPrint: {type: 'boolean', boolean: 'trueOnly'}});
      ...
      test('set true', async () => {
        ...
        Book.defineFields({inPrint: {type: 'boolean', boolean: true}});
    ...
    group('color', () => {
      test('valid alpha', () => {
        const colors = ['#000000', '#12ab3487', '#123456', '#ffffff'], doc = {color: ''};
      ...
      test('valid non-alpha', () => {
        const colors = ['#00000005', '#12ab3480', '#123456', '#ffffff'], doc = {color: ''};
