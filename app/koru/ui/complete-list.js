var $ = Koru.current;
var Tpl = Koru.Form.CompleteList;
var Row = Tpl.Row;
var v;
...
Tpl.$extend({
  $created: function (ctx, elm) {
    ...
    Koru.addClass(elm.firstChild, 'selected');
  },
  $destroyed: function () {
...
function highlight(curElm, newElm) {
  Koru.removeClass(curElm, 'selected');
  Koru.addClass(newElm, 'selected');

}

function close() {
  Koru.remove(v && v.completeList);
}
