define((require, exports, module) => {
  ...
  TH.testCase(module, ({before, beforeEach, afterEach, group, test}) => {
    ...
    test('translate', () => {
      ...
      stubProperty(ResourceString.en, 'test_message', {value: 'testing {0} and {1} and {2}'});
      assert.same(format.translate(['test_message', 'one', 'two', 'three']), 'testing one and two and three');
    });
  });
});
